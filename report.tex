...
O código foi desenvolvido em Python, executado no servidor do grupo de pesquisa LIPAI, e está disponível no \textit{github} [\url{https://github.com/gabrielmbrum/CNN}].
